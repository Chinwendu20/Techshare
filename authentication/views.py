...
from .serializers import  UserSerializer as TheUserSerializer
...
from rest_framework.response import Response
from rest_framework.views import APIView
from authemail.models import SignupCode, EmailChangeCode, PasswordResetCode,send_multi_format_email,SignupCode
from authemail.serializers import SignupSerializer, LoginSerializer,PasswordResetSerializer,PasswordResetVerifiedSerializer,EmailChangeSerializer, PasswordChangeSerializer, UserSerializer
...
class Signup(APIView):
    ...
    @swagger_auto_schema(request_body=TheUserSerializer)
